        ...
        <div class="flex flex-row justify-center w-1/2">
            ...
            <div class="justify-center flex flex-col  h-full items-center ">
                ...
                <div class="flex flex-row pb-6 gap-3  items-center">
                    ...
                    <input  type="text" wire:model="name" class=" w-96 h-10 border-2 border-gray-400 rounded-md placeholder:font-bold placeholder:px-3" placeholder="Nome">
                </div>

                <div class="flex flex-row pb-6 gap-3  items-center">

                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#CB3C68" class="bi bi-person-vcard-fill" viewBox="0 0 16 16">
                        <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm9 1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5M9 8a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4A.5.5 0 0 0 9 8m1 2.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5m-1 2C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 0 2 13h6.96q.04-.245.04-.5M7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0"/>
                    </svg>
                    <input  type="text" wire:model="cpf" class=" w-96 h-10 border-2 border-gray-400 rounded-md placeholder:font-bold placeholder:px-3" placeholder="Cpf">
                </div>
