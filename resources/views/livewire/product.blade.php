    ...
    <div class="px-24 py-10 h-3/4 w-full flex flex-col">
        ...
        <div class="flex flex-row justify-around  pt-10">
            ...
            <div class="flex flex-row gap-6">
                <img src="{{ asset('images/bolo.png') }}" alt="">
                <div class="flex flex-col gap-2">
                    <h1 class="text-4xl font-bold text-pink-500">Bolo de chocolate</h1>
                    <h1 class="text-2xl  text-pink-500">R$ 10,00</h1>
                    <!-- BUTTONS -->
                    <div class="flex flex-row gap-2">
                        ...
                        <button class="h-9 w-40 bg-pink-700 text-white rounded-full ">
            ...
            <div class="flex flex-col gap-2 ">
                ...
                @for ($i = 0; $i < 3; $i++)
                    <div class="flex flex-row gap-4">
                        ...
                        <img src="{{ asset('images/bolo.png') }}" alt="" class="w-40 h-40">
                        <div class="flex flex-col">
                            ...
                            <p class="w-72"> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis id ab eos
                                iure voluptatem, accusantium perferendis ut praesentium libero beatae ipsum dicta natus
                                corrupti. Officia esse architecto sit culpa rerum.</p>
                        </div>
                        ...
                        <div class="flex flex-col justify-center gap-3">
                            ...
                            <button class="h-9 w-36  text-pink-600 border border-pink-600 rounded-full ">
                                <div class="flex flex-row justify-around items-center">
